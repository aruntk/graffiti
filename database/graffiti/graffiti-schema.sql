...
CREATE TABLE IF NOT EXISTS `graffiti`.`app_dashboard` (
  ...
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`app_id`, `dashboard_id`),
  UNIQUE INDEX `app_dashboard_user` (`app_id` ASC, `dashboard_id` ASC, `user_id` ASC),
  INDEX `fk_app_has_dashboard_dashboard1_idx` (`dashboard_id` ASC),
  INDEX `fk_app_has_dashboard_app_idx` (`app_id` ASC),
...
CREATE TABLE IF NOT EXISTS `graffiti`.`chart` (
  ...
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `fk_chart_query1_idx` (`query_id` ASC),
  INDEX `fk_chart_component1_idx` (`component_id` ASC),
...
CREATE TABLE IF NOT EXISTS `graffiti`.`chart_interaction` (
  ...
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`chart_id`, `interaction_id`),
  INDEX `fk_chart_has_interaction_interaction1_idx` (`interaction_id` ASC),
  INDEX `fk_chart_has_interaction_chart1_idx` (`chart_id` ASC),
...
CREATE TABLE IF NOT EXISTS `graffiti`.`column` (
  ...
  INDEX `fk_axis_chart1_idx` (`chart_id` ASC),
...
CREATE TABLE IF NOT EXISTS `graffiti`.`dashboard_chart` (
  ...
  UNIQUE INDEX `chart_dashboard_user` (`dashboard_id` ASC, `chart_id` ASC, `user_id` ASC),
  INDEX `fk_dashboard_has_chart_chart1_idx` (`chart_id` ASC),
  INDEX `fk_dashboard_has_chart_dashboard1_idx` (`dashboard_id` ASC),
...
CREATE TABLE IF NOT EXISTS `graffiti`.`filter` (
  ...
  `values_query` SMALLINT(5) UNSIGNED NOT NULL,
  ...
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `fk_filter_query1_idx` (`query_id` ASC),
  INDEX `fk_filter_query2_idx` (`values_query` ASC),
  INDEX `fk_filter_query3_idx` (`filter_query` ASC),
  INDEX `fk_filter_base_table1_idx` (`base_table_id` ASC),
  CONSTRAINT `fk_filter_base_table1`
    FOREIGN KEY (`base_table_id`)
    REFERENCES `graffiti`.`base_table` (`id`),
  CONSTRAINT `fk_filter_query1`
    FOREIGN KEY (`query_id`)
    REFERENCES `graffiti`.`query` (`id`),
  CONSTRAINT `fk_filter_query2`
    FOREIGN KEY (`values_query`)
    REFERENCES `graffiti`.`query` (`id`),
...
CREATE TABLE IF NOT EXISTS `graffiti`.`dashboard_filter` (
  ...
  INDEX `fk_dashboard_has_filter_filter1_idx` (`filter_id` ASC),
  INDEX `fk_dashboard_has_filter_dashboard1_idx` (`dashboard_id` ASC),
